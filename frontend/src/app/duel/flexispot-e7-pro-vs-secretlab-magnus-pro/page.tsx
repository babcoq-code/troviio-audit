  ...
  return (
    <>
      <JsonLd
        data={{
          "@type": "Article",
          headline: "Flexispot E7 Pro vs Secretlab MAGNUS Pro : le duel des bureaux électriques 2026",
          description: "Qui est le meilleur en bureau électrique assis-debout ? Le Flexispot E7 Pro affronte le Secretlab MAGNUS Pro dans un duel sans merci.",
          url: "https://troviio.com/duel/flexispot-e7-pro-vs-secretlab-magnus-pro",
