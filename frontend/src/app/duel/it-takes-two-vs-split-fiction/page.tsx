...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.troviio.com/duel/it-takes-two-vs-split-fiction" },
};
    ...
    <main className="min-h-screen bg-[#0E1020] text-white">
      <section className="border-b border-white/5 bg-gradient-to-b from-[#1A1D2E] to-[#0E1020]">
        ...
        />
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg leading-8 text-[#8B8FA3]">It Takes Two (98/100) ou Split Fiction (97/100) ? Le choc des titans Hazelight. Quel est le meilleur jeu co-op local ? On tranche.</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
        ...
        <div className="rounded-2xl border border-[#3ED6A3]/30 bg-[#1A2E22] p-6 mb-12">
          ...
          <p className="text-base leading-7 text-[#8B8FA3] whitespace-pre-line">Le gagnant est... **<Link href="/produit/jeu-coop-ittakestwo-ps5" className="text-white hover:text-[#4257FF] transition-colors">It Takes Two</Link>** (98/100), mais de justesse, comme un match de Mario Kart où la tortoise rouge t&#x27;a grillé sur la ligne d&#x27;arrivée. Pourquoi ? Parce que c&#x27;est LE jeu qui a redéfini le genre co-op en 2021 et qui reste une expérience de couple inoubliable. **<Link href="/produit/jeu-coop-splitfiction-ps5" className="text-white hover:text-[#FF6B5F] transition-colors">Split Fiction</Link>** (97/100) est un chef-d&#x27;œuvre technique et narratif, mais *It Takes Two* a cette âme, cette folie douce qui te fait dire \&quot;wow, j&#x27;ai joué à ça avec mon/ma partenaire et on est toujours en vie\&quot;. Si tu veux du spectacle pur, prends *Split Fiction*. Si tu veux une expérience humaine, prends *It Takes Two*. Mais sincèrement, prends les deux. Josef Fares n&#x27;a pas dit \&quot;Fuck the Oscars\&quot; pour rien : ces jeux sont des Oscars à eux tout seuls.</p>
        </div>
