...
const CATEGORIES = [
  { slug: "aspirateur-robot",   label: "Robot aspirateur",   emoji: "🤖", family: "home" as Family, hook: "Sol, animaux, patience" },
  ...
  { slug: "machine-a-cafe",     label: "Machine à café",     emoji: "☕", family: "home" as Family, hook: "Grains, capsules, silence" },
  ...
  { slug: "tv",                 label: "TV OLED",            emoji: "📺", family: "tech" as Family, hook: "Salon, luminosité, gaming" },
  ...
  { slug: "ordinateur-portable",label: "Laptop étudiant",    emoji: "💻", family: "tech" as Family, hook: "Autonomie, légèreté, perfs" },
  { slug: "laptop-etudiant",   label: "Laptop étudiant",    emoji: "💻", family: "tech" as Family, hook: "Autonomie, légèreté, budget" },
  { slug: "laptop-gamer",       label: "Laptop gamer",       emoji: "🎮", family: "tech" as Family, hook: "RTX, écran, puissance" },
  { slug: "enceinte-bt",        label: "Enceinte Bluetooth", emoji: "🔊", family: "tech" as Family, hook: "Portable, autonomie, son" },
  { slug: "velo-electrique",    label: "Vélo électrique",    emoji: "🚲", family: "mobility" as Family, hook: "Autonomie, moteur, confort" },
  { slug: "imprimante",         label: "Imprimante",         emoji: "🖨️", family: "tech" as Family, hook: "Jet, laser, couleur" },
  { slug: "barre-de-son",       label: "Barre de son",       emoji: "🔊", family: "tech" as Family, hook: "TV, gaming, Dolby" },
