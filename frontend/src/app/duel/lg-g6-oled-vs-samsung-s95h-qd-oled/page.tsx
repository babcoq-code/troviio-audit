    ...
    <main className="min-h-screen bg-[#0E1020] text-white">
      ...
      <section className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
        <div className="rounded-2xl border border-white/5 bg-[#161827] p-6 mb-10">
          <p className="text-base leading-7 text-[#8B8FA3] whitespace-pre-line">C'est le clash des Titans, le duel des mastodontes qui font pleurer ton compte en banque plus vite que Thanos en pleine crise de collectionnite. D'un côté, LG avec son OLED G6 qui promet des noirs plus profonds que la dépression d'un personnage de Kaamelott. De l'autre, Samsung avec son MicroLED M9 qui te file l'impression d'avoir un écran de cinéma IMAX dans ton salon, mais à un prix qui ferait pleurer Tony Stark. Accroche-toi, on va voir qui mérite de cramer ton budget 2026.</p>
        </div>

        <div className="mb-12">
          <h2 className="text-2xl font-bold tracking-tight font-display mb-6">⚡ Comparatif rapide</h2>
          <div className="bg-[#161827] rounded-2xl border border-white/5 p-6">
            <p className="text-sm leading-7 text-[#8B8FA3] whitespace-pre-line">- **Qualité d'image** : LG OLED G6 (noirs parfaits, contraste divin) VS Samsung MicroLED M9 (luminosité atomique, couleurs qui claquent) → Égalité : match nul comme un combat de sumo.
- **Taille max** : LG (83 pouces) VS Samsung (146 pouces) → Samsung gagne, tu peux recréer un stade chez toi.
- **Prix** : LG (5 000€ pour le 65") VS Samsung (20 000€ pour le 89") → LG gagne, ton portefeuille te suppliera pas de vendre un rein.
- **Durabilité** : LG (risque de burn-in si tu regardes CNN 24h/24) VS Samsung (MicroLED increvable, pas de pixel qui crame) → Samsung, c'est le Terminator des TV.
- **Design** : LG (ultra-fin, style James Bond) VS Samsung (modulaire, tu peux le coller au mur comme un tableau de Tron) → Égalité, les deux sont plus sexy que Ryan Gosling en costard.</p>
          </div>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2 mb-12">
          <div className="rounded-2xl border border-white/5 bg-[#161827] p-6">
            <h3 className="text-lg font-bold mb-4">🎯 LG G6 OLED 65" est fait pour toi si...</h3>
...
- Le gamer qui veut mater Cyberpunk 2077 version 4K à 240 Hz, et qui a déjà un SSD externe pour stocker ses larmes après l'achat.</p>
          </div>
          <div className="rounded-2xl border border-white/5 bg-[#161827] p-6">
            <h3 className="text-lg font-bold mb-4">🎯 Samsung S95H 65" QD-OLED est fait pour toi si...</h3>
...
- Le geek qui veut une TV qui survive à l'apocalypse et à ses enfants (parce que MicroLED, ça encaisse les chocs mieux que Captain America).</p>
          </div>
        </div>
